...
class ConsumptionPolicy
{
    ...
    {
        return auth()->user()->hasPermission('consumption_access');
    }
    ...
    {
        return auth()->user()->hasPermission('consumption_show');
    }
    ...
    {
        return auth()->user()->hasPermission('consumption_create');
    }
    ...
    {
        return auth()->user()->hasPermission('consumption_edit');
    }
    ...
    {
        return auth()->user()->hasPermission('consumption_delete');
    }
