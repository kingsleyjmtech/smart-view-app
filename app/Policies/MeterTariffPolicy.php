...
class MeterTariffPolicy
{
    ...
    {
        return auth()->user()->hasPermission('meter_tariff_access');
    }
    ...
    {
        return auth()->user()->hasPermission('meter_tariff_show');
    }
    ...
    {
        return auth()->user()->hasPermission('meter_tariff_create');
    }
    ...
    {
        return auth()->user()->hasPermission('meter_tariff_edit');
    }
    ...
    {
        return auth()->user()->hasPermission('meter_tariff_delete');
    }
