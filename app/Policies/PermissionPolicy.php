...
class PermissionPolicy
{
    ...
    {
        return auth()->user()->hasPermission('permission_access');
    }
    ...
    {
        return auth()->user()->hasPermission('permission_show');
    }
    ...
    {
        return auth()->user()->hasPermission('permission_edit');
    }
    ...
    {
        return auth()->user()->hasPermission('permission_delete');
    }
