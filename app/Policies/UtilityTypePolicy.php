...
class UtilityTypePolicy
{
    ...
    {
        return auth()->user()->hasPermission('utility_type_access');
    }
    ...
    {
        return auth()->user()->hasPermission('utility_type_show');
    }
    ...
    {
        return auth()->user()->hasPermission('utility_type_create');
    }
    ...
    {
        return auth()->user()->hasPermission('utility_type_edit');
    }
    ...
    {
        return auth()->user()->hasPermission('utility_type_delete');
    }
