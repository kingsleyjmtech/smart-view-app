...
class UserPolicy
{
    ...
    {
        return auth()->user()->hasPermission('user_access');
    }
    ...
    {
        return auth()->user()->hasPermission('user_show');
    }
    ...
    {
        return auth()->user()->hasPermission('user_edit');
    }
    ...
    {
        return auth()->user()->hasPermission('user_delete');
    }
