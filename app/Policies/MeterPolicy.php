...
class MeterPolicy
{
    ...
    {
        return auth()->user()->hasPermission('meter_access');
    }
    ...
    {
        return auth()->user()->hasPermission('meter_show');
    }
    ...
    {
        return auth()->user()->hasPermission('meter_create');
    }
    ...
    {
        return auth()->user()->hasPermission('meter_edit');
    }
    ...
    {
        return auth()->user()->hasPermission('meter_delete');
    }
