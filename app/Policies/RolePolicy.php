...
class RolePolicy
{
    ...
    {
        return auth()->user()->hasPermission('role_access');
    }
    ...
    {
        return auth()->user()->hasPermission('role_show');
    }
    ...
    {
        return auth()->user()->hasPermission('role_create');
    }
    ...
    {
        return auth()->user()->hasPermission('role_edit');
    }
    ...
    {
        return auth()->user()->hasPermission('role_delete');
    }
